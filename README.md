...
5. **Ошибки деплоя CI/CD**
   ...
   # Решение: docker-compose.yml адаптирован под версию 2.24.6
   # Убраны неподдерживаемые функции (start_period, condition: service_healthy)
   ```
...
> **🔧 Совместимость**: docker-compose.yml адаптирован под версию 2.24.6
